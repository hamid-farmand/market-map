...
const stallData = {
    "1": { name: "حسن فدوی کاشانی", number: "غرفه 1" },
    ...
    "10": { name: "حاج علی ابوالحسنی", number: "غرفه 10" },
    "11": { name: "امیر سحرخوان", number: "غرفه 11" },
    "12": { name: "همایونی - محمدی", number: "غرفه 12" },
    "13": { name: "اصغر و احمد ابوالحسنی", number: "غرفه 13" },
    "14": { name: "علی اکبر حسینی - مسعود گیلاسی", number: "غرفه 14" },
    ...
    "18": { name: "علی رضا ابوالحسنی (هاشمی نسب)", number: "غرفه 18" },
    ...
    "22": { name: "امیر و سعید جعفری- لقبی", number: "غرفه 22" },
    "23": { name: "مرتضی خداوردیان - مسعودحیدریان - علی همایونی", number: "غرفه 23" },
    "24": { name: "علی حمیدی- مشتاق (وهب)", number: "غرفه 24" },
    "25": { name: "هادی دهی", number: "غرفه 25" },
    "26": { name: "ابوالفضل باقی", number: "غرفه 26" },
    "27": { name: "رحمت باقی - حاجتمند", number: "غرفه 27" },
    "27.1": { name: "رضا محمدی - گرمکی", number: "غرفه 27.1" },
    "28": { name: "سلمان کاظمی - رمضان محسنی", number: "غرفه 28" },
    ...
    "34": { name: "اکبر افراشته", number: "غرفه 34" },
    "35": { name: "حاج رضا فدوی", number: "غرفه 35" },
    "36": { name: "حسین ستایش فر", number: "غرفه 36" },
    "37": { name: "محسن زارع", number: "غرفه 37" },
    "38": { name: "مهدی تجلیان مفرد", number: "غرفه 38" },
    "39": { name: "اکبر و محسن رجبعلی", number: "غرفه 39" },
    ...
    "46": { name: "مازوچی - دشتبانی - اکبرزاده", number: "غرفه 46" },
    ...
    "81": { name: "باقی - عباس علیدوست", number: "غرفه 81" },
    ...
    "95": { name: "محمد و مصطفی ابوالحسنی - مشتاقی - جوادزاده", number: "غرفه 95" },
    "96": { name: "فاطمه میرپنجی - امیر رئوفی نیا", number: "غرفه 96" },
    "97": { name: "سید سعید نظام طاهری", number: "غرفه 97" },
    "98": { name: "احمد افراشته - اصغر افراشته", number: "غرفه 98" },
    "99": { name: "سراجی - احمد حمامی", number: "غرفه 99" },
    "100": { name: "پیام", number: "غرفه 100" },
    "101": { name: "یزدان آور", number: "غرفه 101" },
    "102": { name: "مهدی ایلیاتی", number: "غرفه 102" },
    "103": { name: "جعفر خاری زاده", number: "غرفه 103" },
};
